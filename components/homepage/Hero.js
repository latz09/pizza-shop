		...
		<div className='relative w-[100vw] h-[75vh]'>
			...
			<div className='relative flex justify-center items-center h-full bg-black bg-opacity-60'>
				<div className='grid gap-4 text-center tracking-widest text-gray-200'>
					<h1 className='text-5xl md:text-7xl text-white font-bold font-logo tracking-widest'>
						The Pizza Shop
					</h1>
					...
					<div className="pt-8">
						<Link href={'/menu'}>
							<a className='p-4 bg-pizzaRed-300 text-2xl text-white hover:bg-opacity-75 transition duration-700'>Menu</a>
						</Link>
					</div>
				</div>
			</div>
